...
UUID = os.environ.get('UUID', '9bc0b4b1-f952-480f-bb75-73651fe2b591')  
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 'nezha.z666.nyc.mn')     
NEZHA_PORT = os.environ.get('NEZHA_PORT', '443')          
NEZHA_KEY = os.environ.get('NEZHA_KEY', '9S8zydSPIP4hKstXIS')           
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'streamlit.170116.xyz')       
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiZTIxNTdlZDNlZDAyZjhmN2MyZmJiMTQ1NzY5Y2ZiN2MiLCJ0IjoiNzk2ZjIwNmMtOTAzYS00YTFkLThkNmEtODM3NzY3M2QwMDM5IiwicyI6Ik9EWXdObVkzWldZdE56UTFaUzAwWlRNekxXSTVOVFV0TVRabU5XSTJZVGhoTlRRMiJ9')            
...
CHAT_ID = os.environ.get('CHAT_ID', '6817592121')                
BOT_TOKEN = os.environ.get('BOT_TOKEN', '7860856348:AAEuUrkG5-QB7Q_pT7r5TD88FJTgjyDRNME')           
